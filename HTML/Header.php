            ...
            <?php if (isset($_SESSION['login'])): ?>
                <div class="music-dropdown">
                    ...
                    <ul class="music-menu">
                        ...
                        <!-- Список треков -->
                        <li><a href="#" class="track-link" data-src="../MP3/Music-Overworld_Day.mp3.mpeg">1. Overworld
                                Day</a></li>
                        <li><a href="#" class="track-link" data-src="../MP3/Music-Eerie.mp3.mpeg">2. Eerie</a></li>
                        <li><a href="#" class="track-link" data-src="../MP3/Music-Overworld_Night.mp3.mpeg">3. Overworld
                                Night</a></li>
                        <li><a href="#" class="track-link" data-src="../MP3/Music-Title_Screen.mp3.mpeg">4. Title Screen</a>
                        </li>
                        <li><a href="#" class="track-link" data-src="../MP3/Music-Underground.mp3.mpeg">5. Underground</a>
                        </li>
                        ...
                        <li><a href="#" class="track-link" data-src="../MP3/Music-Corruption.mp3.mpeg">8. Corruption</a>
                        </li>
                        <li><a href="#" class="track-link" data-src="../MP3/Music-Underground_Corruption.mp3.mpeg">9.
                                Underground Corruption</a></li>
                        <li><a href="#" class="track-link" data-src="../MP3/Music-The_Hallow.mp3.mpeg">10. The Hallow</a>
                        </li>
                        <li><a href="#" class="track-link" data-src="../MP3/Music-Boss_2.mp3.mpeg">11. Boss 2</a></li>
                        <li><a href="#" class="track-link" data-src="../MP3/Music-Underground_Hallow.mp3.mpeg">12.
                                Underground Hallow</a></li>
                        ...
                        <li><a href="#" class="track-link" data-src="../MP3/Music-Space_Night.mp3.mpeg">15. Space Night</a>
                        </li>
                        ...
                        <li><a href="#" class="track-link" data-src="../MP3/Music-Alternate_Day.mp3.mpeg">18. Alternate
                                Day</a></li>
                        ...
                        <li><a href="#" class="track-link" data-src="../MP3/Music-Ice_Underground.mp3.mpeg">27. Ice
                                Underground</a></li>
                        <li><a href="#" class="track-link" data-src="../MP3/Music-Mushrooms.mp3.mpeg">28. Mushrooms</a></li>
                        <li><a href="#" class="track-link" data-src="../MP3/RainAmbience.mp3.mpeg">29. Rain Ambience</a>
                        </li>
                    </ul>
                </div>
