                        ...
                        <div class="slides" id="slides1">
                                <div class="slide active">
                                        <a href="https://www.youtube.com/playlist?list=PLbc9UrelHDeXJ1QzOzQ_lHNPOyspcb0EI"
                                                target="_blank">
                                                <img src="../Images/Sliders/Террария хардкор.jpeg">
                                        </a>
                                        <h2 class="picture_name">Террария Хардкор</h2>
                                </div>
                                <div class="slide"><a
                                                href="https://www.youtube.com/playlist?list=PLbc9UrelHDeVjghAJA2Htl606OSyqvndv"
                                                target="_blank"><img src="../Images/Sliders/Террария на планетах.jpeg"></a>
                                        <h2 class="picture_name">Террария на планетах</h2>
                                </div>
                                <div class="slide"><a
                                                href="https://www.youtube.com/playlist?list=PLbc9UrelHDeWXoOd0_3EVmYc-f2RrNdZt"
                                                target="_blank"><img src="../Images/Sliders/Микро террария.jpeg"></a>
                                        <h2 class="picture_name">Микро Террария</h2>
                                </div>
                                <div class="slide"><a
                                                href="https://www.youtube.com/playlist?list=PLbc9UrelHDeUv4hMR_hGXZ-t1E3YbQbvl"
                                                target="_blank"><img src="../Images/Sliders/Террария на острове.jpeg"></a>
                                        <h2 class="picture_name">Террария на острове</h2>
                                </div>
                                <div class="slide"><a
                                                href="https://www.youtube.com/playlist?list=PLbc9UrelHDeXn9Fp48UnSAYAirZWE-wRr"
                                                target="_blank"><img src="../Images/Sliders/Террария за йо-йошника.jpeg"></a>
                                        <h2 class="picture_name">Террария за йо-йошника</h2>
                                </div>
                        </div>
                ...
                <div class="slider2" id="slider2">
                        ...
                        <div class="slides" id="slides2">
                                <div class="slide active"><a
                                                ...
                                                target="_blank"><img
                                                        src="../Images/Sliders/Первые алмазы ! Майнкрафт Начало.jpg"></a>
                                        <h2 class="picture_name">Майнкрафт "Начало"</h2>
                                </div>
                                <div class="slide"><a
                                                href="https://www.youtube.com/playlist?list=PLzZ7gRsUjR-SfGRwknOBLzg-18nTaDiRj"
                                                target="_blank"><img
                                                        src="../Images/Sliders/Океанические приключения  в Майнкрафт.jpg"></a>
                                        <h2 class="picture_name">Майнкрафт на острове</h2>
                                </div>
                                <div class="slide"><a
                                                href="https://www.youtube.com/playlist?list=PLzZ7gRsUjR-TyNFdchDxQYI_kyjD_1Th9"
                                                target="_blank"><img src="../Images/Sliders/Майнкрафт 1.17.jpeg"></a>
                                        <h2 class="picture_name">Обзоры обновлений Майнкрафт</h2>
                                </div>
                                <div class="slide"><a
                                                href="https://www.youtube.com/playlist?list=PLzZ7gRsUjR-SWcF-ZSkIcJIc9FBY5LZUl"
                                                target="_blank"><img
                                                        src="../Images/Sliders/Банан ! растения против Зомби 2.jpg"></a>
                                        <h2 class="picture_name">Растения против Зомби</h2>
                                </div>
                                <div class="slide"><a
                                                href="https://www.youtube.com/playlist?list=PLzZ7gRsUjR-RLt1Vonr1e7NGbFK975LvC"
                                                target="_blank"><img
                                                        src="../Images/Sliders/Карточки Покемон сколько заработал.jpg"></a>
                                        <h2 class="picture_name">Карточки Покемон</h2>
                                </div>
                        </div>
                ...
                <div class="slider3" id="slider3">
                        ...
                        <div class="slides" id="slides3">
                                <div class="slide active"><a
                                                ...
                                                target="_blank"><img
                                                        src="../Images/Sliders/Hytale forest biome showcase.jpg"></a>
                                        <h2 class="picture_name">Hytale</h2>
                                </div>
                                <div class="slide"><a
                                                href="https://www.youtube.com/playlist?list=PLTECYQ5EoWN1NGumkLjwMpuUFp9YvK0ZW"
                                                target="_blank"><img
                                                        src="../Images/Sliders/Sylvanus is a carry in this meta Smite conquest gameplay.jpg"></a>
                                        <h2 class="picture_name">Smite</h2>
                                </div>
                                <div class="slide"><a
                                                href="https://www.youtube.com/playlist?list=PLTECYQ5EoWN0QN3zKLU1pSt3Lpp8zcMRH"
                                                target="_blank"><img
                                                        src="../Images/Sliders/Deadlock all heroes and abilities.jpg"></a>
                                        <h2 class="picture_name">Deadlock</h2>
                                </div>
                                <div class="slide"><a
                                                href="https://www.youtube.com/playlist?list=PLTECYQ5EoWN1Ntj2_zVnUefdwlZC2b_ec"
                                                target="_blank"><img src="../Images/Sliders/Smite 2.jpg"></a>
                                        <h2 class="picture_name">Smite 2</h2>
                                </div>
                        </div>
