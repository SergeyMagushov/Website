        ...
        <div class="body1">
            ...
            <div class="zoom-container">
                ...
                <label for="zoom-img-3">
                    <img src="../Images/Gallery/AerKQg41OSo.jpg" alt="Ошибка загрузки">
                </label>
            </div>
            ...
            <div class="zoom-container">
                ...
                <label for="zoom-img-4">
                    <img src="../Images/Gallery/f9132e78ad7c0b0f2ceb00e3347b19bb.1000x1000x1.jpg" alt="Ошибка загрузки">
                </label>
            </div>
            ...
            <div class="zoom-container">
                ...
                <label for="zoom-img-5">
                    <img src="../Images/Gallery/images (1).jfif" alt="Ошибка загрузки">
                </label>
            </div>
        </div>
        ...
        <div class="body1">
            <div class="zoom-container">
                ...
                <label for="zoom-img-6">
                    <img src="../Images/Gallery/i (4).webp" alt="Ошибка загрузки">
                </label>
            </div>
            ...
            <div class="zoom-container">
                ...
                <label for="zoom-img-7">
                    <img src="../Images/Gallery/i (4)(1).webp" alt="Ошибка загрузки">
                </label>
            </div>
            ...
            <div class="zoom-container">
                ...
                <label for="zoom-img-8">
                    <img src="../Images/Gallery/i (5).webp" alt="Ошибка загрузки">
                </label>
            </div>
            ...
            <div class="zoom-container">
                ...
                <label for="zoom-img-9">
                    <img src="../Images/Gallery/i (6).webp" alt="Ошибка загрузки">
                </label>
            </div>
            ...
            <div class="zoom-container">
                ...
                <label for="zoom-img-10">
                    <img src="../Images/Gallery/gggame-гггейм.gif" alt="Ошибка загрузки">
                </label>
            </div>
        </div>
        ...
        <div class="body1">
            <div class="zoom-container">
                ...
                <label for="zoom-img-11">
                    <img src="../Images/Gallery/i (8).webp" alt="Ошибка загрузки">
                </label>
            </div>
            ...
            <div class="zoom-container">
                ...
                <label for="zoom-img-12">
                    <img src="../Images/Gallery/i (9).webp" alt="Ошибка загрузки">
                </label>
            </div>
            ...
            <div class="zoom-container">
                ...
                <label for="zoom-img-13">
                    <img src="../Images/Gallery/i (10).webp" alt="Ошибка загрузки">
                </label>
            </div>
            ...
            <div class="zoom-container">
                ...
                <label for="zoom-img-14">
                    <img src="../Images/Gallery/i (11).webp" alt="Ошибка загрузки">
                </label>
            </div>
            ...
            <div class="zoom-container">
                ...
                <label for="zoom-img-15">
                    <img src="../Images/Gallery/i (12).webp" alt="Ошибка загрузки">
                </label>
            </div>
        </div>
    </div>
