...
// Создание логики процесса сохранения комментария и данных пользователя
if (isset($_POST['button_feedback'])) { // Обозначаем, что все, что внутри, будет работать при нажатии на кнопку с name "button_feedback"
